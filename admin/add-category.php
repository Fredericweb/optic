...
$query=mysqli_query($con,"insert into categorie(libelCategorie) values('$category')");
if($query)
{
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Ajouter Categories</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Ajouter Categories </b></h4>
                                    <hr />
...
<strong>opération effectuée</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post">
	                                            ...
	                                            <!-- <div class="form-group">
	                                                <label class="col-md-2 control-label">Description de categories</label>
	                                                <div class="col-md-10">
