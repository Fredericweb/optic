...
$query=mysqli_query($con,"insert into produit(ModelProd,idCategorie,idMarque,descriptionProd,priceProd,qteProd,imgProd) values('$model','$catid','$subcatid','$postdetails','$price','$quantité','$imgnewfile')");
if($query)
{
$msg="produit ajoutée";
}
...
<input type="text" class="form-control" id="posttitle" name="model" placeholder="ENTRER LE MODEL" required>
</div>
...
// menu deroulant marque
$retm=mysqli_query($con,"select idMarque,libelmarque from marque");
while($resultm=mysqli_fetch_array($retm))
{    
?>
<option value="<?php echo htmlentities($resultm['idMarque']);?>"><?php echo htmlentities($resultm['libelmarque']);?></option>
<?php } ?>
</select> 
</div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Description produit</b></h4>
...
<input type="text" class="form-control" id="posttitle" name="price" placeholder="Prix" required>
</div>

<div class="form-group m-b-20">
<label for="exampleInputEmail1">quantité</label>
<input type="text" class="form-control" id="posttitle" name="quantité" placeholder="quantité" required>
</div>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Sauvegarder</button>
