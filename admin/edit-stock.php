...
$query1=mysqli_query($con,"Select qteProd from  produit where idProd='$postid'");
$row1=mysqli_fetch_array($query1);

$quantite=$_POST['quantité'];
$qteProd= ($quantite + $row1['qteProd']);

$query=mysqli_query($con,"update produit set qteProd='$qteProd' where idProd='$postid'");
...
<input type="text" class="form-control" id="posttitle" name="quantité" required>
</div>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Ajouter</button>
