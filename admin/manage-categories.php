...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update categorie where idCategorie='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  categorie  where idCategorie='$id'");
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Ajouter <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select idCategorie,libelCategorie  from  categorie ");
$cnt=1;
...
<td><?php echo htmlentities($row['libelCategorie']);?></td>
<td><a href="edit-category.php?cid=<?php echo htmlentities($row['idCategorie']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
	&nbsp;
    <a href="manage-categories.php?rid=<?php echo htmlentities($row['idCategorie']);?>&&action=parmdel"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
