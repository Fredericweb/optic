...
$query=mysqli_query($con,"insert into user(nomuser,prenomuser,idSexe,idRole,mdpuser,photouser,login) values('$nom','$Prenom','$sexe','$role','$hashmdp','$imgnewfile','$login')");
if($query)
{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Ajouter un nouveau utilisateur</h4>
...
<input type="text" class="form-control" id="posttitle" name="nom" placeholder="Entrer le nom" required>
</div>
<div class="form-group m-b-20">
<label for="exampleInputEmail1">Prenom</label>
<input type="text" class="form-control" id="posttitle" name="prenom" placeholder="Entrer le prenom" required>
</div>
