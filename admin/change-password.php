...
$sql = mysqli_query($con,"select iduser from user where login='$adminid'");
...
$sql=mysqli_query($con,"SELECT mdpuser FROM  user where iduser=' $iduser'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $dbpassword=$num['mdpuser'];

if (password_verify($password, $dbpassword)) {

 $con=mysqli_query($con,"update user set mdpuser='$newhashedpass' where iduser='$iduser'");
$msg="Mot de passe modifier  !!";
}
}
else
{
$error="Ancien mot de passe ne correspont pas  !!";
}
}
...
<html lang="en">
    <head>
        ...
        <title>ZOOBLAZO OPTIC | Mot de passe</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Changer le mot de passe </b></h4>
                                    <hr />
