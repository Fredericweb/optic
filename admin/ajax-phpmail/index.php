...
$connect = new PDO("mysql:host=localhost;dbname=customer.sql", "root", "");
			...
			<div class="table-responsive">
				...
				foreach($result as $row)
				{
					...
					<tr>
						...
						<td>
						<button type="button" id="email_button" name="" class="btn btn-info btn-xs email_button" id="'.$count.'" data-email="'.$row["customer_email"].'" data-name="'.$row["customer_name"].'" data-action="single">Send Single</button>
						</td>
					</tr>
					';
				}
